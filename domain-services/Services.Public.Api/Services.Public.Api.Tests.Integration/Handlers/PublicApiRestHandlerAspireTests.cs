...
public class PublicApiRestHandlerAspireTests : IAsyncLifetime
{
    ...
    [Fact(DisplayName = "TDD GREEN: GET /api/services - Should Return Paginated Services with Aspire", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: GET /api/services/{slug} - Should Return Service By Slug with Aspire", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: GET /api/services/search - Should Return Filtered Services with Aspire", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: GET /api/services/featured - Should Return Featured Services with Aspire", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: GET /api/services - With Category Filter Should Return Filtered Services", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: REST Endpoints Should Include Standard Observability Headers", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Invalid Page Parameters Should Return BadRequest", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Non-Existent Service Slug Should Return NotFound", Timeout = 30000)]
