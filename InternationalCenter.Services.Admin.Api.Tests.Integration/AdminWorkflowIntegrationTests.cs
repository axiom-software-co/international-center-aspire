...
{
    [Fact(DisplayName = "TDD RED: CreateService Should Persist To Real Database And Create Medical-Grade Audit Trail")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Modify Real Database And Create Medical-Grade Audit Trail")]
    ...
    [Fact(DisplayName = "TDD RED: DeleteService Should Remove From Real Database And Create Medical-Grade Audit Trail")]
    ...
    [Fact(DisplayName = "TDD RED: AdminAPI Should Be Accessible Through Aspire Service Discovery")]
    ...
    [Fact(DisplayName = "TDD GREEN: Real PostgreSQL Database Should Be Available Through Aspire")]
