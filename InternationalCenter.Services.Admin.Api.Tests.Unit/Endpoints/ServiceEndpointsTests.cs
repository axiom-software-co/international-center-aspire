...
public class ServiceEndpointsTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    [Fact(DisplayName = "TDD GREEN: POST /api/admin/services Should Route To CreateService Handler")]
    ...
    [Fact(DisplayName = "TDD GREEN: PUT /api/admin/services/{id} Should Route To UpdateService Handler")]
    ...
    [Fact(DisplayName = "TDD GREEN: DELETE /api/admin/services/{id} Should Route To DeleteService Handler")]
    ...
    [Fact(DisplayName = "TDD GREEN: POST /api/admin/services Should Handle Invalid JSON Serialization")]
    ...
    [Fact(DisplayName = "TDD GREEN: PUT /api/admin/services/{id} Should Validate Service ID Format In Route")]
    ...
    [Fact(DisplayName = "TDD GREEN: Content-Type application/json Should Be Required For POST/PUT")]
    ...
    [Fact(DisplayName = "TDD GREEN: Response Should Include Medical-Grade Audit Headers")]
