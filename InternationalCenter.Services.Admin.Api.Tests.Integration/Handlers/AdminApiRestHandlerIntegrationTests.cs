...
public class AdminApiRestHandlerIntegrationTests : IAsyncLifetime
{
    ...
    [Fact(DisplayName = "TDD GREEN: PUT /admin/api/services/{id} - Should Update Service With Change Tracking")]
    ...
    [Fact(DisplayName = "TDD GREEN: DELETE /admin/api/services/{id} - Should Soft Delete With Audit")]
    ...
    [Fact(DisplayName = "TDD GREEN: PATCH /admin/api/services/{id}/publish - Should Update Status With Audit")]
    ...
    [Fact(DisplayName = "TDD GREEN: POST /admin/api/services - Invalid Request Should Return ValidationError")]
    ...
    [Fact(DisplayName = "TDD GREEN: Admin Operations Should Require Medical-Grade Auth Context")]
    ...
    [Fact(DisplayName = "TDD GREEN: Concurrent Admin Operations Should Handle Optimistic Concurrency")]
