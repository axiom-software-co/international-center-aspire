...
public class ServicesApiAspireIntegrationTests : IClassFixture<DatabaseFixture>, IClassFixture<CacheFixture>, IAsyncLifetime
{
    ...
    [Fact(DisplayName = "TDD RED: Database Connection Should Be Available Via Infrastructure Fixtures", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Redis Connection Should Be Available Via Infrastructure Fixtures", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Database Schema Should Be Available For Services API", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Services Domain Tables Should Be Queryable", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Services API Should Have All Required Dependencies Available", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Services API Should Support CRUD Operations With Real Infrastructure", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Services API Should Handle Database Transactions With Real PostgreSQL", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD RED: Services API Should Support Concurrent Operations With Redis Infrastructure", Timeout = 30000)]
