...
public class AspireRedisInfrastructureTests : IAsyncLifetime
{
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Redis Connection - Should establish connection through orchestration", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Redis Performance - Should meet medical-grade latency through orchestration", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Redis Distributed Operations - Should handle concurrent access", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Redis Configuration Injection - Should provide valid connection strings", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Redis Memory Management - Should handle data operations efficiently", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Service Discovery - Should discover Redis through Aspire naming", Timeout = 30000)]
