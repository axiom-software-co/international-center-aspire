...
public class AdminServiceRepositoryTests
{
    ...
    [Fact(DisplayName = "TDD RED: AdminServiceRepository Should Require Non-Null DbContext Interface")]
    ...
    [Fact(DisplayName = "TDD RED: AdminServiceRepository Should Require Non-Null Logger")]
    ...
    [Fact(DisplayName = "TDD GREEN: GetByIdAsync Should Audit Zero Records When Service Not Found")]
    ...
    [Fact(DisplayName = "TDD GREEN: GetAllAsync Should Log Medical-Grade Audit With Correct Count")]
    ...
    [Fact(DisplayName = "TDD GREEN: GetBySpecificationAsync Should Apply Specification Contract")]
