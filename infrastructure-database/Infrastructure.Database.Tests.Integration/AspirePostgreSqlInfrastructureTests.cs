...
public class AspirePostgreSqlInfrastructureTests : IAsyncLifetime
{
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Authentication - Should handle auth failures gracefully", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Connection Pooling - Should manage connections efficiently", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Service Resilience - Should handle service restarts gracefully", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Transaction Handling - Should rollback on failure", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Performance - Should meet reasonable response times", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Health Monitoring - Should provide comprehensive health checks", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire PostgreSQL Security - Should enforce authentication standards", Timeout = 30000)]
    ...
    [Fact(DisplayName = "TDD GREEN: Aspire Configuration Injection - Should provide correct connection strings", Timeout = 30000)]
