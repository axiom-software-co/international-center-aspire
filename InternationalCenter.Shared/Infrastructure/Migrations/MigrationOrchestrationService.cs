...
public class MigrationOrchestrationService : IMigrationOrchestrationService
{
    ...
    private async Task ValidateServicesSchemaAsync(CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("Migration Orchestrator: Services domain validated - {ServicesCount} services, {CategoriesCount} categories",
    ...
    private async Task ValidateNewsSchemaAsync(CancellationToken cancellationToken)
    {
        ...
        var categoriesCount = await _context.NewsCategories.CountAsync(cancellationToken);
        
        _logger.LogInformation("Migration Orchestrator: News domain validated - {ArticlesCount} articles, {CategoriesCount} categories",
            articlesCount, categoriesCount);
    }
