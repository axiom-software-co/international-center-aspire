...
public class MigrationAuditService : IMigrationAuditService
{
    ...
    public Task<IEnumerable<DomainMigrationAuditEntry>> GetMigrationHistoryAsync(string domain, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return Task.FromResult<IEnumerable<DomainMigrationAuditEntry>>(auditHistory);
        }
        catch (Exception ex)
        {
