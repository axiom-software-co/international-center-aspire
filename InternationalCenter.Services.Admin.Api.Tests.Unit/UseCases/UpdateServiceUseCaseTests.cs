...
public class UpdateServiceUseCaseTests
{
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Fail With Null Request")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Fail With Empty ServiceId")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Fail With Missing UserContext")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Fail With Excessively Long Title")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Fail When Service Not Found")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Handle Repository Failure Gracefully")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Succeed With Valid Title Update")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Succeed With Availability Toggle")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Log Medical-Grade Audit Trail")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Handle Multiple Field Updates")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Handle Partial Updates")]
    ...
    [Fact(DisplayName = "TDD RED: UpdateService Should Handle Concurrent Updates")]
